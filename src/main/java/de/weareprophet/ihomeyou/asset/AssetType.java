...
public enum AssetType {
    Shelf("Shelf", "Stores anything.", "shelf", 40, 0,
            NeedsFulfillment.builder().add(Storage, 20).add(Decoration, 10).add(PersonalNeeds, 10).build()),
    ...
    Wardrobe("Wardrobe", "Stores clothes.", "wardrobe", 120, 1,
            NeedsFulfillment.builder().add(Storage, 90).add(PersonalNeeds, 30).build()),
    Music("Sound system", "Pure entertainment.", "music-home-theatre", 500, 2,
            NeedsFulfillment.builder().add(Comfort, 80).add(Luxury, 300).add(PersonalNeeds, 120).build()),
    KitchenTable("Kitchen table", "Used to sit and eat.", "kitchen-table", 60, 0,
            NeedsFulfillment.builder().add(Food, 10).add(Comfort, 20).add(PersonalNeeds, 15).add(Decoration, 15).build()),
    Curtains("Curtains", "Make the room more cozy.", "curtains", 40, 1,
            NeedsFulfillment.builder().add(Decoration, 20).add(PersonalNeeds, 20).build()),
    PrayerCarpet("Prayer carpet", "Used to pray.", "prayer-carpet", 20, 0,
            NeedsFulfillment.builder().add(PersonalNeeds, 20).build()),
    ...
    DinnerTable("Dinner table", "Classy way to eat.", "dinner-table", 120, 2,
            NeedsFulfillment.builder().add(Food, 20).add(Comfort, 40).add(Decoration, 30).add(PersonalNeeds, 30).build()),
    Picture("Picture", "A fine painting.", "picture", 250, 1,
            NeedsFulfillment.builder().add(Decoration, 100).add(PersonalNeeds, 50).add(Luxury, 100).build()),
    ...
    Toilet("Toilet", "Where the best ideas come from.", "toilet", 80, 0,
            NeedsFulfillment.builder().add(Cleanliness, 40).add(PersonalNeeds, 40).build()),
    ...
    Tv("TV", "Amazing movies.", "tv", 800, 1,
            NeedsFulfillment.builder().add(Luxury, 600).add(PersonalNeeds, 200).build()),
    ...
    Fishbowl("Fishbowl", "Provides company.", "fishbowl", 50, 1,
            NeedsFulfillment.builder().add(Decoration, 20).add(PersonalNeeds, 30).build());
